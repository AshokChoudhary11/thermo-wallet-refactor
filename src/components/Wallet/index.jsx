...
import WalletDetailsCard from "../Cards/WalletDetailsCard";
            ...
            <div className="rounded-lg border border-default-200">
              <div className="p-6">
                    ...
                    <span className="flex w-full flex-wrap items-center justify-start gap-4">
                      ...
                      <div className="flex w-full items-center">
                        <span className="grow text-start">
                          <span className="block text-lg font-medium text-default-950">
                            Kaiya Botosh
                          </span>
                          <span className="block text-xs font-medium text-default-950">
                            demoexample@mail.com
                          </span>
                        </span>
                        <span className="shrink">
                ...
                <div className="mb-6 text-center">
                  <h6 className="mb-2 text-lg font-semibold text-default-600">
                    Total Balance
                  </h6>
                  <h3 className="mb-2 text-3xl font-semibold text-default-900">
                    {currentCurrency}81,957.50
                  </h3>
                ...
                <div className="mb-6 rounded-lg border border-default-100 bg-white shadow dark:bg-default-100">
                  <div className="p-4">
                    <h6 className="mb-3 text-lg font-semibold text-default-900">
                      Quick transfer
                    </h6>
                ...
                <div>
                  <h6 className="relative mb-3 inline-block text-lg font-semibold text-default-900">
                    Due{" "}
                    <span className="absolute start-full top-1 inline-flex h-2 w-2 items-center rounded-full bg-primary" />
                  </h6>
                  <div className="mb-4 flex w-full flex-wrap items-start gap-4 sm:flex-nowrap">
                    ...
                    <div className="flex w-full items-center">
                      <span className="grow text-start">
                        <span className="block text-lg font-medium text-default-900">
                          Madelyn Torff
                        </span>
                        <span className="mb-0.5 block text-xs font-medium text-default-600">
                          Just sent you {currentCurrency}500
                        </span>
                        <span className="inline-block border-b border-primary text-xs font-medium text-primary">
