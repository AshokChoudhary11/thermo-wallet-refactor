        ...
        {cards.map((card, idx) => {
          return (
            <SwiperSlide key={card.id}>
              <div
                style={{ backgroundImage: `url(${walletCardBgPaymentImg})` }}
                className={cn(
                  "overflow-hidden rounded-lg bg-cover bg-right-bottom bg-no-repeat",
                  bgColors[idx]
                )}
              >
                <div className="p-6">
                      ...
                      <div className="flex gap-4">
                        {card.cardNo
                          ...
                          ?.map((chunk, idx) => (
                            <span
                              key={idx}
                              className="font-sans line-clamp-1 text-xl font-semibold tracking-widest text-white"
                            >
                              {chunk}
                            </span>
                          ))}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="w-1/2">
                      ...
                      <h3 className="line-clamp-1 text-lg font-semibold uppercase text-white">
