...
export const clientAppDemosData = [
  {
    link: "/dishes",
    name: "Dishes Grid",
    image: demo2Img,
...
export const adminPanelDemosData = [
  {
    link: "/admin/wallet",
    name: "Wallet",
    image: demoAdmin1Img,
...
export const landingFeaturesData = [
  {
